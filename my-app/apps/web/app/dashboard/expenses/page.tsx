		...
		<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-3 md:p-6 relative">
			...
			<div className="relative max-w-6xl mx-auto">
				<header className="mb-6 md:mb-8 animate-fadeIn">
					...
					<h1 className="text-2xl md:text-3xl font-bold text-white">Mes Dépenses</h1>
					<p className="text-gray-400 mt-1 text-sm md:text-base">Historique de vos dépenses</p>
				</header>
				...
				<div className="bg-gradient-to-br from-red-500/20 to-orange-500/10 backdrop-blur-xl border border-red-500/20 rounded-2xl p-4 md:p-6 mb-6 md:mb-8 animate-fadeIn">
					<div className="flex items-center gap-3 mb-2">
						<div className="w-9 md:w-10 h-9 md:h-10 bg-red-500/20 rounded-xl flex items-center justify-center flex-shrink-0">
							<svg className="w-4 md:w-5 h-4 md:h-5 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
